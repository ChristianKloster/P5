...
def load_feature_file(filePath):
	return pd.read_csv(filePath, encoding='utf-8',
								...
								dtype={
									...
									'quantity7d':np.float64,
									'quantity30d':np.float64,
									'discount_percent':np.float64,
									'avg_price_style':np.float64,
									'color':np.float64,
									'lifetimeChain':np.float64,
									'lifetimeRetailer':np.float64,
									'accelerationChainStyle':np.float64,
									'accelerationRetailerStyle':np.float64,
									'PLCBD':np.float64,
									'PLCCD':np.float64,
									'quantityPeriod1':np.float64,
				                    'quantityPeriod2':np.float64,
									'p1-p2':np.float64,
									'quantityPeriod3':np.float64,
									'p2-p3':np.float64})
