...
def error_plotter(df, path, modelname):
    data = df.copy()
    ...
    plt.title('SSE')
    plt.tight_layout()
    plt.savefig(path + 'SSE' + modelname + '.png')
    ...
    plt.title('RMS')
    plt.tight_layout()
    plt.savefig(path + 'RMS' + modelname + '.png')
    ...
    plt.title('MSE')
    plt.tight_layout()
    plt.savefig(path + 'MSE' + modelname + '.png')
    ...
    plt.title('Max Error')
    plt.tight_layout()
    plt.savefig(path + 'MaxError' + modelname + '.png')
...
MFirst = pd.read_csv(patrick_dir + 'FirstNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MSecond = pd.read_csv(patrick_dir + 'SecondNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MThird = pd.read_csv(patrick_dir + 'ThirdNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MFourth = pd.read_csv(patrick_dir + 'FourthNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MFifth = pd.read_csv(patrick_dir + 'FifthNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MSixth = pd.read_csv(patrick_dir + 'SixthNB1ErrorFrame.rpt', sep=';').dropna(how='any')
MSeventh = pd.read_csv(patrick_dir + 'SeventhNB1ErrorFrame.rpt', sep=';').dropna(how='any')

compare_models(MFirst, MSecond)
compare_models(MFirst, MThird)
compare_models(MFirst, MFourth)
compare_models(MFirst, MFifth)
compare_models(MFirst, MSixth)
compare_models(MFirst, MSeventh)
compare_models(MFirst, MNB)
# error_plotter(MFirst)
# error_plotter(MSecond)