...
def plotplc(retailer = 'alle', generer_fra = 'description', percent_of_interest = 20):
    ...
    #d_region = rddf.get_retailers_from_region('Fyn')
    ...
    #plc(d, 'PLC/{0}/{1}/{2}'.format(retailer, generer_fra, 'isMale_JEANS_WOMEN'), ignore_returns = 0)
...
plotplc('alle', percent_of_interest=40)
